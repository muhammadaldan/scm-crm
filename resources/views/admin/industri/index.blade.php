                ...
                <div class="card h-100">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="card-title mb-0">
                            <h5 class="m-0 me-2">Industri List</h5>
                        </div>
                        <a href="{{ route('industri.create') }}" class="btn btn-primary">Create</a>
                    </div>
                    <div class="card-body">
                        <table class="table w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">
                                        <div class="d-flex">
                                            <a href="{{ route('industri.edit', $item->id) }}" class="btn btn-primary me-2">Edit</a>
